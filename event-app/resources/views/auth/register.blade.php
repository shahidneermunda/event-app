            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-title">
                        <h2>Register Us By Email!</h2>
                        <p>Fill out the form below to host your own event freely.</p>
                    </div>
                </div>
            </div>
            <div class="row" >
                        ...
                        <div class="row" style="padding: 10px;">
                            ...
                            <div class="col-lg-3">
                                <select name="gender" id="gender" class="form-control @error('gender') is-invalid @enderror" required>
                                    ...
                                    <option value="Male" @if(old('gender')=='Female') selected @endif>Female</option>
                                </select>
                                @error('gender')
                                <span class="invalid-feedback text-danger" role="alert">
                                        <strong>{{ $message }}</strong>
                            ...
                            <div class="col-lg-3">
                                <input id="dateofbirth" type="text" placeholder="Date of Birth" onfocus="(this.type='date')" class="form-control @error('dateofbirth') is-invalid @enderror" name="dateofbirth" value="{{ old('dateofbirth') }}" required autocomplete="dateofbirth">
